...
import bgImage2 from "../../public/vectors/figure.svg";

function MainNav() {
  return (
    <section className="relative  ">
      <div>
        <div className="w-full h-full absolute bg-cover bg-no-repeat top-0 left-0 right-0 bottom-0    -z-20">
          <Image className="" src={bgImage} />
        </div>

        <div className="absolute bg-cover bg-no-repeat top-0 h-full  right-0 bottom-0 w-6/12 left-[630px] -z-10 ">
          <Image className="h-full" src={bgImage2} />
        </div>
      </div>
